...
def home():
    ...
    for data in stock_result:
        if data[1] not in unique_stcok_list:
            unique_stcok_list.append(data[1])
    ...
    # 計算單一股票資訊
    stock_info = []
    for stock in unique_stcok_list:
    ...
    if len(unique_stcok_list) != 0:
        labels = tuple(unique_stcok_list)
...
# print(cash_result) return tuple of list
# print(currency) return dict n key
# print(stock_result) 兩筆資料
